(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (The Williams Companies, Inc.,
  LEI D71FAKCBLFS2O0RBPG08) -- unlike `commitledger.store`'s multi-application
...
(defn demo-company []
  {:legal-name "The Williams Companies, Inc."
   :website    "https://www.williams.com"})

(def ^:private demo-full-text
  "Vendor Terms & Conditions\nThese Williams Vendor Terms and Conditions govern all Purchase Orders issued by The Williams Companies, Inc. to suppliers and contractors providing goods or services related to our energy-infrastructure and midstream operations, unless superseded by a separate written agreement. Vendors must comply with all applicable safety, procurement, and invoicing requirements referenced in the applicable Purchase Order. These Terms are governed by the laws of the State of Delaware.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.williams.com/vendor-terms-conditions/"
   ...
   :doc-type     :vendor-terms-and-conditions})
